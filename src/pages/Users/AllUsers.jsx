...
function AllUsers() {
  ...
  if (isSuccess) return (
    <div className="wrapper relative flex flex-col items-center gap-5 ">
      ...
      {editedItem && (
        <EditUserModal data={editedItem} setShowEditModal={setEditedItem} />
      )}

      <div className="flex justify-between w-full items-center p-2">
        <h1 className="title flex items-center  gap-3 lg:text-4xl text-3xl">Users <Users size={30} color="#214440" /></h1>
